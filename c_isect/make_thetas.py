...
for filename in train_filenames:
    os.system("./cmake-build-debug/c_isect ../data/training_data/" + filename + " ../data/train_thetas/out" + filename)
...
for filename in test_filenames:
    os.system("./cmake-build-debug/c_isect ../data/test_data/" + filename + " ../data/test_thetas/out" + filename)
